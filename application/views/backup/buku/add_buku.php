        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add List Buku</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('table_buku/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="row">
								<div class="form-group col-md-3">
									<label for="nama_buku">Nama Buku*</label>
									<input class="form-control <?php echo form_error('nama_buku') ? 'is-invalid':'' ?>"
									 type="text" name="nama_buku" placeholder="Nama Buku" />
